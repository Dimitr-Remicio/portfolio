const ThemeToggle = (action) => {
    return(
        <div >
            
        <svg className='iconModeDark' xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="none" id="chk"
              onClick={() =>ction}>
              <path className='linedarkmd' stroke="" stroke-linecap="square" stroke-width="2" d="M1 9.76V1h9.345M37.21 1h8.76v8.76m0 25.699v9.345h-8.76m-26.866 0H1v-9.345"/>
